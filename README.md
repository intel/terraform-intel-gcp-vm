...
| <a name="input_machine_type"></a> [machine\_type](#input\_machine\_type) | The machine type to create | `string` | `"c3-highcpu-4"` | no |
...
| <a name="input_user_data"></a> [user\_data](#input\_user\_data) | User data (e.g. cloud-init) to be placed on the instance | `string` | `null` | no |
